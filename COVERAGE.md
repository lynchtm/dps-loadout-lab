...
| Loadouts | 1–32 independent setups, names/descriptions, copying/reordering/removal, live loading, named scenarios, item-source searches | Standalone item/loadout preset library, web share format compatibility |
...
| Validation | 150 inherited pinned reference cases and broader tests; added scenario and Swing lifecycle tests | Latest-Wiki-generated fixtures, full fuzz campaign, in-game checks, production release review |

## Known changes since the reference

Compared the current source at `89c3e25` with `b6bc098d`. The main combat file has 203
...
Affected common setups receive explicit scenario warnings. The equipment catalog remains
