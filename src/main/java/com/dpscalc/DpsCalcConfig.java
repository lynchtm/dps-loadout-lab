...
public interface DpsCalcConfig extends Config {
    @ConfigItem(keyName = "automaticRefresh", name = "Automatic refresh", description = "Refresh live DPS once per game tick", position = 100)
    default boolean automaticRefresh() { return true; }
    @ConfigItem(keyName = "npcMenu", name = "NPC Calculate DPS menu", description = "Add a read-only DPS action to attackable NPC menus", position = 101)
    default boolean npcMenu() { return true; }
