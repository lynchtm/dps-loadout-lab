...
/**
 * Immutable snapshot of a player's gear loadout at a specific point in time. Used for comparing DPS
 * across different equipment configurations.
 *
 * <p>Identity is based on timestamp - each snapshot is unique by creation time. Arrays are
...
public class GearSnapshot {
    ...
    public String getCombatStyleName() {
        return combatStyleName;
    }

    public String getCombatStyleStance() {
        return combatStyleStance;
    }
    ...
    public boolean isAssumeMaxBoosts() {
        return assumeMaxBoosts;
    }

    public boolean isUseBestOffensivePrayer() {
        return useBestOffensivePrayer;
    }
